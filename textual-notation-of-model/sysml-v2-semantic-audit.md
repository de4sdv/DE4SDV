...
- Functional item defs now structurally reuse generated/extended VSS signal definitions via direct `attribute` declarations and recursive import; the earlier alias-only pattern has been replaced. Accepted functional interfaces, signal ownership/direction semantics, and upstream suitability of DE4SDV extension signals still need a separate interface/refinement increment.
