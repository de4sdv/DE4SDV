...
- **generated COVESA VSS attribute definitions** reused where existing signal semantics are available;
...
- **VSS-backed signal semantics** as catalog references, not as architecture topology or implementation ownership.
