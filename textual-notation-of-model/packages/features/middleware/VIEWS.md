...
- **Exposes:** `MiddlewarePhysicalSoftwareBoundary::adapter`, `MiddlewarePhysicalSoftwareBoundary::adapter::**`, `MiddlewarePhysicalSoftwareBoundary::aaosSdvBoundary`, `MiddlewarePhysicalSoftwareBoundary::aaosSdvBoundary::*`, `MiddlewarePhysicalSoftwareBoundary::autowareRos2Boundary`, `MiddlewarePhysicalSoftwareBoundary::autowareRos2Boundary::*`
- **Depth:** `-1`
- **Render:** `asInterconnectionDiagram`

_Diagram not present: `diagrams/diagram-mwAdapterBoundaryExchangeView.svg` (regenerate via the Privileged Syside Validation workflow)._
...
- **Exposes:** `mw010ReferenceContractClaim`, `signalTranslationArgument010`, `vehicleStartupArgument010`, `contractAndRehearsalEvidence010`, `boundedAAOSBootBaseline010`, `claimSupportedBySignalArgument`, `claimSupportedByStartupArgument`, `contractEvidenceReinforcesArgument`, `bootBaselineReinforcesArgument`
- **Render:** `asTreeDiagram`
