...
- **Exposes:** `boundedBaselineDecision010`, `successorIncrementDecision010`, `mw010ReferenceContractClaim`, `signalTranslationArgument010`, `healthForwardingArgument010`, `vehicleStartupArgument010`, `faultDetectionArgument010`, `contractAndRehearsalEvidence010`, `boundedAAOSBootBaseline010`, `runtimeCampaignEvidence011`, `runtimeAdapterPathEvidence012`, `runtimeAutowareConsumerEvidence013`, `runtimeHealthDispositionEvidence014`, `claimSupportedBySignalArgument`, `claimSupportedByHealthArgument`, `claimSupportedByStartupArgument`, `claimSupportedByFaultArgument`, `contractEvidenceReinforcesArgument`, `bootBaselineReinforcesArgument`, `runtimeCampaignReinforcesSignalArgument`, `runtimeCampaignReinforcesStartupArgument`, `runtimeCampaignReinforcesFaultArgument`, `runtimeAdapterPathReinforcesSignalArgument`, `runtimeAdapterPathReinforcesStartupArgument`, `runtimeAdapterPathReinforcesFaultArgument`, `runtimeAutowareConsumerReinforcesSignalArgument`, `runtimeHealthDispositionReinforcesHealthArgument`, `runtimeCampaignTraceToClaim`, `runtimeAdapterPathTraceToClaim`, `runtimeAutowareConsumerTraceToClaim`, `runtimeHealthDispositionTraceToClaim`, `boundedClaimToBaselineDecision010`, `runtimeCampaignToBaselineDecision010`, `runtimeAdapterPathToBaselineDecision010`, `runtimeAutowareConsumerToBaselineDecision010`, `runtimeHealthDispositionToBaselineDecision010`, `successorIncrementToBaselineDecision010`
- **Render:** `asTreeDiagram`
