...
EXPECTED_SCENARIO = "SCN-AEBS-009B-MOVING-VEHICLE-001"
...
def verify(bench: Path, inherited_bench: Path) -> None:
    ...
    expected_scalars = {
        ...
        "status": "executed_evidence_pending_review",
    }
    ...
    scenario = load_yaml(bench / "config/scenario-009b-moving-vehicle-target.yaml")
...
def main() -> int:
    ...
    try:
        ...
        return 1
    print("009B runtime lock and inherited 009A inputs verified; retained scenario evidence remains pending review.")
    return 0
