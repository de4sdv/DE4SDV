...
| [o4/o4-execution-plan.md](o4/o4-execution-plan.md) + [o4-execution-register.json](o4/o4-execution-register.json) | O4 execution register + wave plan, mechanically derived from the accepted review: all 93 identities accounted exactly once, one proposed migration wave per retained target, blockers/dependencies/closure boundary, first-wave recommendation. Planning only — no semantic migration. |
