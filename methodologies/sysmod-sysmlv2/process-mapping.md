...
|---|---|---|---|
| 0 — Increment framing | `aebs_increment_framing.sysml` (3 views) | `middleware_increment_framing.sysml` | `aebs-increment-framing.yaml`, `middleware-adapter-increment-framing.yaml` |
| 1 — Concern framing | stakeholder/concern parts in `aebs_increment_framing.sysml` | stakeholder/concern parts in `middleware_increment_framing.sysml` | increment-framing YAML above |
| 2 — Operational context | `aebs_operational_context.sysml` | `middleware_operational_context.sysml` (3 views) | `aebs-operational-context.yaml`, `aebs-operational-story.md`, `middleware-operational-context.yaml` |
| 3 — Capability/feature semantics | product-line classification view in `aebs_increment_framing.sysml` | `middleware_feature_classification.sysml` | `middleware-feature-classification.yaml` |
| 4 — Needs | needs slices in `aebs_needs_requirements.sysml` | `middleware_stakeholder_needs.sysml` | `aebs-needs-requirements.md`/`.yaml`, `middleware-stakeholder-needs.yaml` |
| 5 — Requirements | `aebs_needs_requirements.sysml` (5 views) | `middleware_requirements.sysml` (2 views) | `aebs-needs-requirements.md`/`.yaml`, `middleware-requirements.yaml` |
| 6 — Functional architecture | `aebs_functional_architecture.sysml` (2 views) | `middleware_functional_architecture.sysml` (2 views) | `aebs-functional-architecture.md`/`.yaml`, `aebs-functional-interfaces.md`/`.yaml`, `middleware-functional-architecture.yaml` |
| 7 — Logical architecture | `aebs_logical_architecture.sysml` (6 views) | `middleware_logical_architecture.sysml` (2 views) | `aebs-logical-architecture.md`/`.yaml`, `middleware-logical-architecture.yaml` |
| 8 — Physical/software realization | `aebs_physical_software_realization.sysml` (7 views), `aebs_execution_environment.sysml` (2 views), `aebs_simulation_deployment.sysml` (17 views) | `middleware_physical_software_realization.sysml` (7 views) | `aebs-physical-software-realization.md`/`.yaml`, `aebs-simulation-deployment.md`/`.yaml`, `middleware-physical-software-realization.yaml` |
| 9 — Variability and configuration | variation-modeling gaps in needs slices; configurations in `model-based-product-line-engineering/` | `middleware_variability_configuration.sysml` (2 views) | `middleware-variability-configuration.yaml`, `model-based-product-line-engineering/feature-configurations/` |
| 10 — V&V and evidence | `aebs_nominal_evidence.sysml`, `aebs_bicycle_verification.sysml`, `aebs_degraded_input_verification.sysml`, `aebs_non_activation_verification.sysml`, `aebs_partial_intervention_verification.sysml`, `aebs_pedestrian_verification.sysml`, `aebs_regulatory_criterion_verification.sysml` | `middleware_verification_evidence.sysml` (2 views) | `middleware-v-and-v-evidence.yaml`; implementation evidence under `implementation/` |
