...
EXPECTED_ASPECTS = {
    ...
    "LogicalStructureDefinitionViewpoint": "Taxonomy & Structure",
    "LogicalInternalExchangeViewpoint": "Interaction & Collaboration",
    "LogicalInternalInteractionViewpoint": "Interaction & Collaboration",
    "LogicalFunctionalMappingViewpoint": "Process & Behavior",
